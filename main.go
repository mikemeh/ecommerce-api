...
import (
	...
	"github.com/yourusername/ecommerce-api/controllers"
	_ "github.com/yourusername/ecommerce-api/docs"
...
func main() {
	...
	v1 := r.Group("/api/v1")
	{
		...
		{
			products.POST("/", middleware.AdminMiddleware(), productController.CreateProduct)
			products.GET("/", productController.GetProducts)
			products.GET("/:id", productController.GetProduct)
			products.PUT("/:id", middleware.AdminMiddleware(), productController.UpdateProduct)
			products.DELETE("/:id", middleware.AdminMiddleware(), productController.DeleteProduct)
		}
		...
		orders.Use(middleware.AuthMiddleware())
		{
			...
			orders.PUT("/:id/status", middleware.AdminMiddleware(), orderController.UpdateOrderStatus)
		}
	}
